...
[O'Reilly Free Programming Books](http://www.oreilly.com/programming/free/)
 [`direct-links`]( https://www.reddit.com/r/learnprogramming/comments/556kxj/oreilly_offering_programming_ebooks_for_free/)  
...
### <i class="fa fa-angle-double-right"></i> Reference
...
[LLVM C++ Standard Library](http://libcxx.llvm.org/)
                   [`html`](http://libcxx.llvm.org/docs/)
                    [`src`](http://llvm.org/svn/llvm-project/libcxx/trunk/)  
[Boost C++ Library](http://www.boost.org/doc/libs/)  
...
[Autoconf](https://www.gnu.org/software/autoconf/manual/index.html)
...
[M4 Macro Processor](https://www.gnu.org/software/m4/manual/index.html)
...
[Flex & Bison - O'Reilly Book](http://web.iitd.ac.in/~sumeet/flex__bison.pdf)
...
[Learning the Korn Shell - O'Reilly CD Book](https://docstore.mik.ua/orelly/unix3/korn/index.htm)  
...
[Sed & Awk - O'Reilly CD Book](https://docstore.mik.ua/orelly/unix3/sedawk/index.htm)  
[Lua 5.3](https://www.lua.org/)
  [`man`](https://www.lua.org/manual/5.3/)  
[Moonscript](http://moonscript.org)
     [`man`](http://moonscript.org/reference/)  
[Python](https://www.python.org)
     [`2`](ttps://docs.python.org/2)
     [`3`](ttps://docs.python.org/3)  
[Node.js](https://nodejs.org)
  [`man`](https://nodejs.org/dist/latest-v6.x/docs/api/all.html)  
...
[LaTeX](https://www.latex-project.org/)
 [`cheat-sheet`](https://wch.github.io/latexsheet/latexsheet-a4.pdf)
 [`quick-ref`](http://www.icl.utk.edu/~mgates3/docs/latex.pdf)
 [`ref-man`](http://texdoc.net/texmf-dist/doc/latex/latex2e-help-texinfo/latex2e.pdf)  
